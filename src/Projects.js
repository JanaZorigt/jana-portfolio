    ...
    <div className="Projects">
      <div className="container">
        <div className="row mt-5">
          ...
          <div className="col-md-6">
            <h2>Architecture Landing Page</h2>
            <p className="mt-3">
              ...
              landing page about Architecture. The page utilizes JavaScript
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-6">
            ...
            <p className="mt-3">
              RESPONSIVE
              <br />I entered the world of front-end development by gaining some
              knowledge in HTML, CSS, and JavaScript. I used my knowledge of
              these languages, along with my new skills in VS Code, to build a
              landing page about Architecture. The page utilizes JavaScript
              functions to create user interaction.
